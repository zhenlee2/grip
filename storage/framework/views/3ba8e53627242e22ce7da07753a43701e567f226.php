                    ...
                    <div class="dropdown-basic">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                ...
                                <a id="pdfButton" href="<?php echo e(url('/gadar-pdf')); ?>" target="_blank">PDF</a>
                            </div>
                        </div>
                        <div>
                        </div>
                  ...
                  <table class="table border table-xs" style="padding: 1px 1px; " >
                     <thead class="sticky-header">
                        ...
                        <?php $__currentLoopData = $gadar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($key === 0): ?>
                                <th class="border p-1" style="text-align: center; vertical-align: middle; padding: 1px;">FY <?php echo e($g->year); ?> Physical Target</th>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $gadar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($key === 0): ?>
                            <th class="border p-1" style="text-align: center; vertical-align: middle; padding: 1px;">FY <?php echo e($g->year); ?> Actual Accomplishment</th>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($g->gadcategory_id == 1 ): ?>
                                ...
                                <tr class="budget-rowa">
                                    ...
                                    <td class="border p-1" align="center">
                                        <button class="btn-xs btn-outline-success " type="submit" id="view" onclick="get_indicator()" data-bs-original-title="Add Accomplishment" data-bs-toggle="modal" data-idUpdate="" data-bs-target="#editModal" <?php echo e($disableAddButton); ?>><span class="icon-save-alt"></span></button>
                                        <br>
                                        <br>
                                    ...
                                    <td class="border p-1" style="text-align: center; <?php echo e($textRed); ?>" data-targetts="<?php echo e($g->target_totalsex); ?>">
                                        <span>M: <?php echo e($g->target_male); ?></span><br>
                                        <span>F: <?php echo e($g->target_female); ?></span><br>
                                        <span>T: <?php echo e($g->target_totalsex); ?></span>
                                    </td>
                                    ...
                                    <td class="border p-1" style="text-align: center; <?php echo e($textRed); ?>" data-phytotal="<?php echo e($g->physical_sextotal); ?>">
                                        <span>M: <?php echo e(number_format($g->physical_male, 0, '.', ',')); ?></span><br>
                                        <span>F: <?php echo e(number_format($g->physical_female, 0, '.', ',')); ?></span><br>
                                        <span>Oth: <?php echo e(number_format($g->physical_other, 0, '.', ',')); ?></span><br>
                                        <span>T: <?php echo e(number_format($g->physical_sextotal, 0, '.', ',')); ?></span>
                                    </td>
                                    ...
                                    <td class="border p-1 col-1" style="text-align: center; <?php echo e($textRed); ?>" data-totalamount="<?php echo e($g->budget_totalamount); ?>"><?php echo e(number_format( $g->budget_totalamount, 1, '.', ',')); ?></td>
                                    ...
                                    <td class="border p-1 col-1" style="text-align: center; <?php echo e($textRed); ?> " data-expen="<?php echo e($g->total_actualexpen); ?>"><?php echo e(number_format($g->total_actualexpen, 1, '.', ',')); ?></td>
           ...
           <div class="card-body">
            <div class="dt-ex">
                    <table class="table border table-sm" style=" padding: 1px 1px; " id="export-button">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $gadarlog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border">
                                    <td colspan="1" class="border" style="text-align: center; vertical-align: middle; padding: 4px;">
                                        <?php if($log->created_at): ?>
                                            <?php echo e(\Carbon\Carbon::parse($log->created_at)->format('F d, Y h:i:s')); ?>

                                        <?php endif; ?>
                                    </td>
                                    <!-- <td colspan="1" class="border" style="text-align: center; vertical-align: middle; padding: 4px;"><?php echo e($loop->iteration); ?></td> -->
                                    <td colspan="1" class="border" style="text-align: center; vertical-align: middle; padding: 4px;"><?php echo e($log->indicator_code); ?></td>
                                    <td colspan="1" class="border" style="text-align: center; vertical-align: middle; padding: 4px;"><?php echo e($log->rawresponsible_unit); ?></td>
                                </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>             
                        </tbody>
                    </table>
        ...
        <div class="modal-content">
            <div class="card">
                <div class="modal-header">
                            <?php $__currentLoopData = $gadar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($key === 0): ?>
                                <h5 class="modal-title" id="updatelogsModalLabel">Status of Submission <?php echo e($g->year); ?></h5>
                                <!-- <th class="border col-1" rowspan="1" colspan="1" style="text-align: center; vertical-align: middle; padding: 4px;">FY <?php echo e($g->year); ?> Actual Accomplishment</th> -->
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
$(document).ready(function() {
    function updateExportHref() {
        var selectedYear = $('#filter_year').val();
        var selectedQuarter = $('#quarter').val();
        var baseUrl = "<?php echo e(route('gadar.export', ['year' => ':year', 'quarter' => ':quarter'])); ?>";
...
$(document).ready(function() {
    function updateExportHref() {
        var selectedYear = $('#filter_year').val();
        var selectedQuarter = $('#quarter').val();
        var baseUrl = "<?php echo e(route('gadar-pdf', ['year' => ':year', 'quarter' => ':quarter'])); ?>";
