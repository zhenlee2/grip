...
<link id="color" rel="stylesheet" href="<?php echo e(asset('assets/css/color-3.css')); ?>" media="screen">
<!-- Responsive css-->
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/responsive.css')); ?>">

<?php /**PATH C:\laragon\www\caraga-pdps.dswd.gov.ph\resources\views/layouts/simple/css.blade.php ENDPATH**/ ?>