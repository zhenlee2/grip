...
<!-- Plugins JS Ends-->
<!-- Theme js-->
<script src="<?php echo e(asset('assets/js/script.js')); ?>"></script><?php /**PATH C:\laragon\www\grip.dswd.gov.ph\resources\views/layouts/errors/script.blade.php ENDPATH**/ ?>