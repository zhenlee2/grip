...
<body class="legal landscape">
  ...
  <section class="sheet page">
    <div class="container-fluid">       
      ...
      <table id="opcprint" class="table table-bordered table-xs demo" style="border-color: black;margin-bottom: 0px; margin-top: 0px;">                
          <thead>
...
</html><?php /**PATH C:\laragon\www\caraga-pdps.dswd.gov.ph\resources\views/pages/opcpage/officepcPrint.blade.php ENDPATH**/ ?>