		...
		<nav class="sidebar-main">
			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav <?php echo e(Route::currentRouteName()=='gadgpb' ? 'active' : ''); ?>" href="<?php echo e(route('gadgpb.year', ['year' => date('Y')])); ?>"><i data-feather="edit"> </i><span>GAD GPB</span></a></li>
