            ...
            <div class="card-body">
					...
					<div class="card o-hidden">
						...
						<div class="card-header-right">
							...
							<div class="media">
								...
								<h4 class="f-w-500 mb-0 f-26"><span class="counter"><?php echo e($totalBudget); ?></span></h4>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-6">
					<div class="card o-hidden">
						...
						<div class="media">
							<div class="media-body">
								<p><span class="f-w-500 font-roboto">Over All Level Total </span><span class="f-w-700 font-primary ms-2"></span></p>
