					...
					<div class="card-body">
							...
							<form method="POST" action="<?php echo e(route('profile.update')); ?>">
								...
								<div class="mb-3">
									...
									<textarea class="form-control" rows="3" name="bio"><?php echo e(old('bio', $user->bio)); ?></textarea>
								</div>
								<div class="mb-3">
									<label class="form-label">Username</label>
									<input class="form-control" name="username" value="<?php echo e(old('username', $user->username)); ?>" placeholder="Username">
								</div>
								<div class="mb-3">
