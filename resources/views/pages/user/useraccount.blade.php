            ...
            $("#basicScenario").jsGrid({
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        type: "text",
                        title: "Role",
                        validate: { message: "Role", validator: "rangeLength", param: [1, 250] },
                        width: 150
                    },
                    {
                        name: "fname",
                        type: "text",
                        title: "First Name",
                        validate: { message: "First Name", validator: "rangeLength", param: [1, 250] },
                        width: 150
                    },
                    {
                        name: "lname",
                        type: "text",
                        title: "Last Name",
                        validate: { message: "Last Name", validator: "rangeLength", param: [1, 250] },
                        width: 150
                    },
                    {
                        name: "division",
                        type: "text",
                        title: "Division",
                        validate: { message: "Division", validator: "rangeLength", param: [1, 250] },
                        width: 150
                    },
                    {
                        name: "section",
                        type: "decimal",
                        title: "Section",
                        validate: { message: "Section",  validator: "range", param: [1, 80] }, 
                        width: 85
                    },
                    {
                        name: "username",
                        type: "decimal",
                        title: "Username",
                        validate: { message: "Username",  validator: "range", param: [1, 80] }, 
                        width: 85
                    },
                    {
                        name: "password",
                        type: "decimal",
                        title: "Password",
                        validate: { message: "Password",  validator: "range", param: [1, 80] }, 
                        width: 85
                    },
                    // {
                    //     name: "office_id",
